-- =====================================================================
-- Migration: Tạo hàm RPC hỗ trợ Admin truy vấn dữ liệu tổng quan
-- Chạy với quyền SECURITY DEFINER để Admin lấy được dữ liệu thống kê
-- =====================================================================
...
BEGIN
    ...
    -- 3. Tính toán các chỉ số thống kê tổng hợp (KPI)
