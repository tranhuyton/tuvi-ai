      ...
      <div className="flex-1">
        ...
        {isRestoringSession ? (
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-end max-w-[1060px] mx-auto">
              ...
              <div className="flex items-center gap-2">
                {currentTier === 'pro' ? (
                  ...
                  <div className="flex items-center gap-2">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs sm:text-sm font-medium bg-slate-900/90 border border-slate-700 text-slate-300">
            ...
            <div className="mt-8 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-5 sm:p-7 rounded-2xl border border-amber-500/30 text-slate-100 flex flex-col md:flex-row items-center justify-between gap-5 print:hidden shadow-xl">
              <div className="space-y-2 text-center md:text-left">
                ...
                <div className="flex items-center gap-1.5 text-sm sm:text-xs text-amber-300/90 pt-1">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto shrink-0">
                ...
                <a
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 bg-[#0068FF] hover:bg-[#0054cc] text-white font-bold rounded-xl text-sm sm:text-base shadow-md transition transform hover:-translate-y-0.5"
                >
