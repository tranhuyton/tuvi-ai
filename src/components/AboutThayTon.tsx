    ...
    >
      ...
      <div className="relative overflow-hidden rounded-3xl backdrop-blur-xl bg-slate-900/85 border border-amber-500/30 p-6 sm:p-10 shadow-2xl shadow-amber-950/20">
        ...
        <div className="relative z-10 text-center max-w-2xl mx-auto mb-8 sm:mb-12">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-amber-500/15 border border-amber-500/35 text-amber-300 text-xs font-semibold uppercase tracking-widest mb-3 shadow-sm">
        ...
        <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-8 sm:mb-12">
          <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-950/60 border border-amber-500/20 text-center hover:border-amber-500/40 transition">
            <div className="text-xl sm:text-2xl font-black text-amber-400 font-serif">18+ Năm</div>
          ...
          <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-950/60 border border-amber-500/20 text-center hover:border-amber-500/40 transition">
            <div className="text-xl sm:text-2xl font-black text-amber-400 font-serif">7+ Năm</div>
            <div className="text-[11px] sm:text-xs text-slate-400 mt-0.5 font-medium">
          ...
          <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-950/60 border border-amber-500/20 text-center hover:border-amber-500/40 transition">
            <div className="text-xl sm:text-2xl font-black text-amber-400 font-serif">Top 5 UK</div>
            <div className="text-[11px] sm:text-xs text-slate-400 mt-0.5 font-medium">
              Đại học Lancaster (Tài chính - Kế toán)
            </div>
          </div>

          <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-950/60 border border-amber-500/20 text-center hover:border-amber-500/40 transition">
            <div className="text-xl sm:text-2xl font-black text-amber-400 font-serif">15+ Năm</div>
            <div className="text-[11px] sm:text-xs text-slate-400 mt-0.5 font-medium">
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 mb-8 sm:mb-12">
          ...
          <div className="p-5 sm:p-6 rounded-2xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/30 transition flex flex-col justify-between space-y-4">
            <div className="space-y-3">
              ...
              <h3 className="text-base sm:text-lg font-bold text-blue-300 font-serif">
              ...
              <ul className="text-xs sm:text-sm text-slate-300 space-y-2 leading-relaxed">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    >
                      TonyEnglish.vn <ExternalLink className="w-3 h-3 inline" />
                    </a>.
                  </span>
                </li>
                <li className="flex items-start gap-2">
          ...
          <div className="p-5 sm:p-6 rounded-2xl bg-slate-950/70 border border-slate-800 hover:border-amber-500/30 transition flex flex-col justify-between space-y-4">
            <div className="space-y-3">
              ...
              <h3 className="text-base sm:text-lg font-bold text-purple-300 font-serif">
        ...
        <div className="relative z-10 bg-gradient-to-r from-amber-500/10 via-slate-900/90 to-amber-500/10 p-5 sm:p-7 rounded-2xl border border-amber-500/30">
          <div className="flex flex-col md:flex-row items-center justify-between gap-5">
            <div className="space-y-2 text-center md:text-left">
              <div className="inline-flex items-center gap-2 text-amber-400 font-serif font-bold text-base sm:text-lg">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 shrink-0 w-full md:w-auto">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white border border-slate-700 text-xs sm:text-sm font-semibold transition"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 text-xs sm:text-sm font-bold shadow-md shadow-amber-500/20 transition"
